...
export default function GuestHome() {
  ...
  // Hide main scrollbar on home page
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    async function loadLocations() {
      try {
        ...
        const fetchedLocations = Array.isArray(data?.locations)
          ? (data.locations as MapProps["locations"])
          : [];
        if (!cancelled) {
  ...
  const organizationSchema = useMemo(
    () => ({
      ...
      description:
        "Aerodynamic roof boxes, cargo boxes, and extra car storage rental service across Sweden and the Nordics",
      sameAs: [],
    }),
    [siteUrl]
  );
  ...
  const serviceSchema = useMemo(
    () => ({
      ...
      description:
        "Rent roof boxes, cargo boxes, and extra car storage solutions. Aerodynamic back-mounted design reduces drag and improves fuel efficiency. Perfect for travel, camping, and everyday storage needs.",
      offers: {
        "@type": "Offer",
  ...
  const productSchema = useMemo(
    () => ({
      ...
      description:
        "Aerodynamic back-mounted cargo box and roof box engineered for reduced drag, better range, and quieter rides. Provides extra car storage for travel, camping, and everyday use.",
          ...
          <section className="relative flex items-center justify-center overflow-hidden animate-fadeIn min-h-screen">
            ...
            <FadeInSection className="relative z-20 mx-auto max-w-5xl px-6 py-24 text-center">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-lg text-gray-200/90">
                IXTAbox is now available for rent. Get extra storage without the hassle of a roof
                box. It mounts to your towbar in minutes, mounted at a comfortable height, and keeps
                your gear within easy reach. Perfect for trips, sports, camping, or everyday
                activities.
              </p>
              ...
              <div className="grid gap-12 lg:grid-cols-[320px_minmax(0,1fr)]">
                <div>
                  ...
                  <p className="mt-3 text-gray-300/90">
                    Every deployment follows a tested playbook. Work with our launch team or plug
                    into your own operations and unlock new revenue in days.
                  </p>
                </div>
          ...
          <FadeInSection>
            <section className="relative overflow-hidden min-h-screen min-h-[100dvh]">
              ...
              <div className="relative z-20 mx-auto max-w-5xl px-6 py-16">
                ...
                <p className="mt-3 text-gray-200 text-center">
                ...
                <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-gray-200">
                  <li className="rounded-lg bg-white/5 border border-white/10 px-4 py-3">
                    LED lighting in and out (Pro)
                  </li>
                  <li className="rounded-lg bg-white/5 border border-white/10 px-4 py-3">
                    Crash‑tested fixation device (Pro)
                  </li>
                  <li className="rounded-lg bg-white/5 border border-white/10 px-4 py-3">
                    Optional 12V outlet and handles
                  </li>
                  <li className="rounded-lg bg-white/5 border border-white/10 px-4 py-3">
            ...
            <section className="mx-auto max-w-7xl px-6 py-16">
              <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/10 p-8 shadow-[0_0_24px_rgba(34,211,238,0.25)] text-center">
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-6">
                  <span className="rounded-full bg-white/10 px-6 py-2 text-base">
                    Lower turbulence behind car
                  </span>
                  <span className="rounded-full bg-white/10 px-6 py-2 text-base">
                    Up to better efficiency
                  </span>
            ...
            <section className="px-6 pb-16">
              <div className="mx-auto max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
                ...
                <p className="mt-2 text-gray-300">
                  Join the IXTAbox journey and pack it all-smart, safe, and in style.
                </p>
