...
const JOURNEY_STEPS_OWNER = [
  { icon: "📍", title: "Register your location", highlight: "Step 1", description: "Choose your area on the map. A vague coverage zone protects your privacy while letting renters find you." },
        ...
        <FadeInSection>
          <section className="px-6 pb-16">
            <div className="mx-auto max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
              ...
              <p className="mt-2 text-gray-300">IXTAowner is coming soon. Sign up to get notified when you can start earning from your box.</p>
              <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/auth/register" className="inline-flex items-center justify-center rounded-full bg-cyan-500 px-6 py-3 text-base font-semibold text-white hover:bg-cyan-400 transition-colors shadow-[0_0_24px_rgba(34,211,238,0.45)]">Get notified</Link>
